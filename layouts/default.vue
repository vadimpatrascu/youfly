...
<template>
  <div class="min-h-screen flex flex-col bg-gray-50 font-sans">
    ...
    <a href="#main-content" class="sr-only focus:not-sr-only focus:fixed focus:top-2 focus:left-2 focus:z-[300] focus:bg-brand-600 focus:text-white focus:px-4 focus:py-2 focus:rounded-lg focus:font-semibold focus:shadow-lg">
      {{ t('nav.skipToMain') }}
    </a>
